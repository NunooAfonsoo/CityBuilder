	...
	public class AILerp : VersionedMonoBehaviour, IAstarAI {
		...
		public Vector3 target {
			get {
				...
				return setter != null ? setter.target : new Vector3(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity);
			}
			set {
				targetCompatibility = new Vector3(float.PositiveInfinity, float.PositiveInfinity, float.PositiveInfinity);
				var setter = GetComponent<AIDestinationSetter>();
		...
		public System.Action<Vector3> onSearchPath { get; set; }
